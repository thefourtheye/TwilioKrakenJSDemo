...
module.exports = function(options) {
    ...
    return {
        ...
        "purge": function(database, table, queryFields, callBack) {
            var tableName = database && _.isString(database) ? database + "." : "" + table,
        ...
        "insert": function(database, table, columns, values, callBack) {
            var tableName = database && _.isString(database) ? database + "." : "" + table,
        ...
        "update": function(database, table, updateData, queryFields, callBack) {
            var tableName = database && _.isString(database) ? database + "." : "" + table,
            ...
            logger("DEBUG", query);
            db.run(query, updateValues.concat(values), callBack);
        }
    };
};